...
# from services.modeling_service import ModelingService  # Temporariamente comentado
# from services.simulation_service import SimulationService  # Temporariamente comentado
from services.budgeting_service import BudgetingService

# Sprint 6+ Services
from services.print3d_service import Print3DService
from services.collaboration_service import CollaborationService
# from services.marketplace_service import MarketplaceService  # Temporariamente comentado
...
# from routes.modeling import router as modeling_router  # Temporariamente comentado
# from routes.simulation import router as simulation_router  # Temporariamente comentado
from routes.budgeting import router as budgeting_router

# Sprint 8-9: Simulation Reports
# from routes.simulation_reports import router as simulation_reports_router  # Temporariamente comentado

# Sprint 10-11: Production System
from routes.production import router as production_router

# Sprint 6+ Routers
# from routers.printing3d import router as printing3d_router  # Temporariamente comentado
# from routers.collaboration import router as collaboration_router  # Temporariamente comentado
# from routers.marketplace import router as marketplace_router  # Temporariamente comentado
# from routers.cloud_rendering import router as cloud_rendering_router  # Temporariamente comentado
...
# modeling_service = ModelingService()  # Temporariamente comentado
# simulation_service = SimulationService()  # Temporariamente comentado
budgeting_service = BudgetingService()

# Initialize Sprint 6+ services
print3d_service = Print3DService()
collaboration_service = CollaborationService()
# marketplace_service = MarketplaceService()  # Temporariamente comentado
...
# app.include_router(modeling_router)  # Temporariamente comentado

# Include simulation routes (Sprint 4)
# app.include_router(simulation_router, prefix="/api", tags=["simulation"])  # Temporariamente comentado

# Include simulation reports routes (Sprint 8-9)
# app.include_router(simulation_reports_router, prefix="/api/v1/simulation-reports", tags=["simulation-reports"])  # Temporariamente comentado
...
# app.include_router(printing3d_router, prefix="/api/v1/printing3d", tags=["printing3d"])  # Temporariamente comentado
# app.include_router(collaboration_router, prefix="/api/v1/collaboration", tags=["collaboration"])  # Temporariamente comentado
# app.include_router(marketplace_router, prefix="/api/v1/marketplace", tags=["marketplace"])  # Temporariamente comentado
# app.include_router(cloud_rendering_router, prefix="/api/v1/cloud-rendering", tags=["cloud-rendering"])  # Temporariamente comentado
